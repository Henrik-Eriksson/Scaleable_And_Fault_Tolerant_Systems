...
export const fetchUsers = async () => {
    try {
        const response = await axios.get('http://20.45.152.9:5050/api/users');
...
export const loginUser = async (username, password, rememberMe) => {
    try {
        const response = await axios.post('http://20.45.152.9:5050/api/users/login', {
            username,
            password
        });
...
export const registerUser = async (formData) => {
    try {
        const response = await axios.post('http://20.45.152.9:5050/api/users/signup', formData);
        if (response.status === 200) {
...
export async function authenticate()
{
  ...
  } else
  {
    ...
    try {
    const response = await axios.post('http://20.45.152.9:5050/api/users/userId', {
