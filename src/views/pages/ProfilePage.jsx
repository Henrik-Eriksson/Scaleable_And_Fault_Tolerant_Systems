  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch user details
        const userResponse = await fetch(`http://internal-api-service.default.svc.cluster.local:5050/api/users/${userId}`);
        const userData = await userResponse.json();

        // Fetch user events
        const eventResponse = await fetch(`http://internal-api-service.default.svc.cluster.local:5050/api/users/getEvents`, {
          method: 'POST',
          headers: {
