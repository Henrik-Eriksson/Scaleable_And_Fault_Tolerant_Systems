...
const playNotificationSound = () => {
  const audio = new Audio('../../../pling.mp3'); // Adjust the path if your audio file is located elsewhere
  audio.play();
};
    ...
    <AppBar position="static" sx = {{backgroundColor: '#0F8294'}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Avatar src= "../../../Fish_icon.png" sx={{ display: { xs: 'none', md: 'inline'}, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <Avatar src= "../../../Fish_icon.png" sx={{ display: { xs: 'flex', md: 'none'}, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
